namespace Host
{
    ...
    {        
        ...
        public DemoEventProcessorFactory(string hostname, string partitionNumber)
        {
        ...
        public string PartitionNum { get; private set; }
        ...
        {
            // Tested by Walker, Only read it by partiton number
            if (context.Lease.PartitionId.Equals(PartitionNum))
            {
